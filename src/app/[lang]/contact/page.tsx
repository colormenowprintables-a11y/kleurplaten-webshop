...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
 ...
 return {
 title: lang ==='en'?'Contact | ColorMeNow.shop':'Contact | ColorMeNow.shop',
 description: lang ==='en'?'Get in touch with the ColorMeNow team. We love hearing from our community!':'Neem contact op met het ColorMeNow team. We horen graag van onze community!',
 };
}
...
export default async function ContactPage({ params }: { params: Promise<{ lang: string }> }) {
 ...
 ✉️ <a href="mailto:colormenowprintables@gmail.com"style={{ color:'inherit', textDecoration:'underline'}}>colormenowprintables@gmail.com</a>
 </p>
