...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    title: lang === 'en' ? 'About Us | ColorMeNow' : 'Over Ons | ColorMeNow',
    description:
      lang === 'en'
        ? 'Learn about ColorMeNow — our mission to make high-quality, creative printable coloring books and art resources accessible for families, artists, and hobbyists worldwide.'
        : 'Leer meer over ColorMeNow — onze missie om hoogwaardige, creatieve printbare kleurboeken en hulpmiddelen toegankelijk te maken voor gezinnen, hobbyisten en kunstenaars.',
    openGraph: {
      title: lang === 'en' ? 'About ColorMeNow' : 'Over ColorMeNow',
      description:
        lang === 'en'
          ? 'Printable coloring books, educational guides, and creative resources for all ages.'
          : 'Printbare kleurboeken, educatieve gidsen en creatieve hulpmiddelen voor alle leeftijden.',
    ...
    ? [
        {
          ...
          desc: 'Every illustration is designed with sharp, high-resolution lines optimized for crisp printing on standard home and school printers.',
        },
        {
          icon: '📚',
        ...
        {
          icon: '🌱',
          title: 'Creative & Accessible',
          desc: 'Creativity should be joyous and accessible. All printable pages, activity sheets, and educational guides are designed with love for personal use.',
        },
        {
          icon: '🛡️',
    ...
    : [
        {
          ...
          desc: 'Elke illustratie is ontworpen met scherpe, hoge-resolutie lijnen geoptimaliseerd voor haarscherp printen op elke printer.',
        },
        {
          icon: '📚',
        ...
        {
          icon: '🌱',
          title: 'Creatief & Toegankelijk',
          desc: 'Creativiteit hoort voor iedereen plezierig te zijn. Al onze kleurboeken en gidsen zijn ontworpen met liefde voor thuis en in de klas.',
        },
        {
          icon: '🛡️',
      ...
      <div className="page-hero">
        <div className="container" style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '1.15rem', color: 'var(--gray-600)', lineHeight: 1.7 }}>
            {isEn
              ? 'ColorMeNow is a creative digital library dedicated to providing high-quality printable coloring pages, mindfulness activities, and art resources for children, parents, teachers, and hobbyists.'
              : 'ColorMeNow is een creatieve digitale bibliotheek gewijd aan hoogwaardige printbare kleurplaten, mindfulness-activiteiten en kunsthulpmiddelen voor kinderen, ouders, docenten en creatievelingen.'}
          </p>
        </div>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '3rem', alignItems: 'center', marginBottom: '5rem' }}>
          <div>
            <h2 className="title-h2" style={{ marginBottom: '1rem' }}>
              {isEn ? 'Why We Created ColorMeNow' : 'Waarom ColorMeNow Ontstaan Is'}
            </h2>
            ...
            <p style={{ color: 'var(--gray-600)', lineHeight: 1.8 }}>
              {isEn
                ? 'Frustrated by cluttered websites full of low-resolution images and broken print formats, we built ColorMeNow with a clean, modern experience that puts high-quality art first.'
                : 'Omdat veel bestaande websites vol staan met wazige afbeeldingen en onhandige printformaten, hebben we ColorMeNow ontworpen met een overzichtelijke, moderne interface waarin kwaliteit en gebruiksgemak centraal staan.'}
            </p>
          </div>
          <div style={{ background: 'var(--surface-2, #f8fafc)', borderRadius: 'var(--radius-xl, 24px)', padding: '2.5rem', border: '1px solid var(--gray-200)' }}>
            <h3 style={{ fontSize: '1.25rem', fontWeight: 800, marginBottom: '1rem', color: 'var(--foreground)' }}>
              {isEn ? '📊 By the Numbers' : '📊 ColorMeNow in Cijfers'}
            </h3>
            <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              <li style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                <span style={{ fontSize: '1.5rem' }}>🎨</span>
                <div>
                  <strong style={{ display: 'block', fontSize: '1.1rem' }}>6,200+</strong>
