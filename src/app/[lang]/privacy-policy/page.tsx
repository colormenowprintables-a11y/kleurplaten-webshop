...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
 ...
 return {
 title: lang ==='en'?'Privacy Policy | ColorMeNow':'Privacybeleid | ColorMeNow',
 description: lang ==='en'?'Read the Privacy Policy for ColorMeNow — how we handle cookies, Google AdSense, Analytics, and GDPR data protection.':'Lees het Privacybeleid van ColorMeNow — hoe wij omgaan met cookies, Google AdSense, Analytics en AVG gegevensbescherming.',
 };
}
...
export default async function PrivacyPolicyPage({ params }: { params: Promise<{ lang: string }> }) {
 ...
 <p>
 {isEn
 ?'ColorMeNow ("we", "us", or "our") operates the website colormenow.shop ("the Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.':'ColorMeNow ("wij", "ons" of "onze") beheert de website colormenow.shop ("de Dienst"). Deze pagina informeert u over ons beleid met betrekking tot het verzamelen, gebruiken en openbaar maken van persoonsgegevens wanneer u onze Dienst gebruikt en de keuzes die u heeft met betrekking tot dat gegevens.'}
 </p>
 ...
 <p>
 {isEn
 ?'ColorMeNow is designed to be accessible without requiring any user registration or account creation. We collect minimal personal data under the following circumstances:':'ColorMeNow is ontworpen om toegankelijk te zijn zonder dat gebruikersregistratie of het aanmaken van een account vereist is. Wij verzamelen een minimale hoeveelheid persoonsgegevens in de volgende gevallen:'}
 </p>
