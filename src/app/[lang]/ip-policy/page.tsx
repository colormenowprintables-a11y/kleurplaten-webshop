export default async function IPPolicyPage({ params }: { params: Promise<{ lang: string }> }) {
 ...
 <p>This Policy pertains to the content by ColorMeNow (“the Corporation”) through the website at colormenow.shop.</p>
 ...
 {isEn
 ?'ColorMeNow is an independent provider of printable coloring pages for personal and educational coloring. All trademarked brand names, franchise characters, and logos mentioned or referenced on this website belong to their respective copyright and trademark owners. ColorMeNow is not affiliated with, sponsored by, or endorsed by any of these entities. Brand names and character references are used strictly for descriptive identification under nominative fair use.':'ColorMeNow is een onafhankelijke aanbieder van printbare kleurplaten voor persoonlijk en educatief kleuren. Alle merknamen, franchisekarakters en logo\'s die op deze website worden genoemd of waarnaar wordt verwezen behoren toe aan hun respectievelijke auteursrecht- en merkhouders. ColorMeNow is op geen enkele wijze gelieerd aan, gesponsord door of goedgekeurd door deze entiteiten. Merknamen en karakterreferenties worden uitsluitend gebruikt voor beschrijvende identificatie onder fair use.'}
 </p>
 </div>
 ...
 <p>Dispatch a message to the Corporation at <strong>colormenowprintables@gmail.com</strong> comprising the ensuing details:</p>
 <ul style={{ paddingLeft:'2rem', display:'flex', flexDirection:'column', gap:'0.5rem'}}>
 ...
 <a href="mailto:colormenowprintables@gmail.com"style={{ display:'inline-block', background:'var(--primary)', color:'white', padding:'0.75rem 1.5rem', borderRadius:'var(--radius)', textDecoration:'none', fontWeight:'bold'}}>Email colormenowprintables@gmail.com</a>
 </div>
 </div>
 </div>
 </div>
