  ...
  return (
    ...
    >
      ...
      <p style={{ margin: 0 }}>
        {isEn ? (
          <>
            All trademarks, logos, characters, and related indicia associated with <strong>{themeTitle}</strong> belong to their respective copyright and trademark owners. ColorMeNow.shop does not claim any ownership of these intellectual properties. All coloring sheets on this platform are line drawings intended exclusively for non-commercial, educational, and personal creative use. Copyright holders can request prompt removal via our{' '}
