  ...
  return (
    <>
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <div>
            ...
            <p style={{ margin: '0.2rem 0 0', fontSize: '0.9rem', color: '#E0E7FF' }}>
              {isEn
                ? `High-resolution printable book. Single book for €1.99 or get 3 books for €4.49!`
                : `Haarscherp printbaar boek. Los boek voor € 1,99 of 3 boeken voor € 4,49!`}
            </p>
          </div>
        </div>
        ...
        >
          {downloading
            ...
            : (isEn ? 'Download PDF Book (€1.99)' : 'Download PDF Kleurboek (€ 1,99)')}
        </button>
      </div>
      ...
      <PayPalCheckoutModal
        ...
        bookTitle={`${themeTitle} Kleurboek`}
        isEn={isEn}
        onSuccessDownload={handleGeneratePdf}
      />
    </>
  );
}
