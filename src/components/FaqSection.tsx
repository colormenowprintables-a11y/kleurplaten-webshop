...
export default function FaqSection({ isEn }: { isEn: boolean }) {
  ...
  const faqs: FaqItem[] = isEn
    ? [
        {
          question: 'What format are ColorMeNow coloring books and 3D covers delivered in?',
          answer: 'All ColorMeNow coloring books and covers are delivered as high-resolution (300 DPI) PDF files ready for instant digital download and crisp home printing.'},
        {
    ...
    : [
        {
          question: 'In welk formaat worden de ColorMeNow kleurboeken geleverd?',
          answer: 'Alle ColorMeNow kleurboeken en 3D covers worden geleverd als hoge resolutie (300 DPI) PDF-bestanden die je direct digitaal kunt downloaden en uitprinten.'},
        {
